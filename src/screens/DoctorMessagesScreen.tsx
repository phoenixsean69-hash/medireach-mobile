    ...
    >
      <View style={styles.heading}>
        ...
        <Text style={styles.subtitle}>
          {t(
            "Secure conversations where your doctor account is a participant.",
          )}
        </Text>
      </View>
      ...
      {loading ? (
        ...
        <View style={styles.stateCard}>
          ...
          <Text style={styles.stateText}>
            {t(
              "Conversations involving this doctor account will appear here.",
            )}
          </Text>
        </View>
      ) : (

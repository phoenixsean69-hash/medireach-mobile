...
import {
  loadDoctorHomeSnapshot,
  type DoctorHomeSnapshot,
    ...
    >
      <View style={styles.hero}>
        ...
        <Text style={styles.subtitle}>
          {t(
            "Clinical review, referrals and coordinated patient care.",
          )}
        </Text>
      ...
      <View style={styles.actions}>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.actionText}>
              {t(
                "Review patient records available to your account.",
              )}
            </Text>
          </View>
        </Pressable>
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.actionText}>
              {t(
                "Review care packets, encounters and referrals.",
              )}
            </Text>
          </View>
        </Pressable>

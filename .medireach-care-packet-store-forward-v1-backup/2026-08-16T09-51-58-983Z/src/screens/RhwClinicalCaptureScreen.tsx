  ...
  async function save() {
    ...
    try {
      ...
      setSavedMessage(
        result.status ===
          "queued"
          ? `Saved safely on this device. Offline decision support: ${triageLabel}. The encounter will synchronize when connectivity returns.`
          : `Clinical capture saved. Decision support: ${triageLabel}.`,
      );
      ...
      Alert.alert(
        ...
        result.status ===
          "queued"
          ? `Stored on this device and waiting to synchronize. Offline decision support: ${triageLabel}.`
          : `Encounter, vitals and decision-support result saved. Triage: ${triageLabel}.`,
      );
    }
    catch (
      error: any
